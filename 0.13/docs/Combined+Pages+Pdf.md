...
sbt 0.13.12's many new capabilities can be a bit overwhelming, but
this page should help you migrate to 0.13.12 with a minimum of fuss.
...
#### Step 1: Read the Getting Started Guide for sbt 0.13.12

Reading the [Getting Started Guide][Getting-Started] will
probably save you a lot of confusion.

#### Step 2: Install sbt 0.13.12

Download sbt 0.13.12 as described on
[the setup page][Setup].

You can run 0.13.12 the same way that you run 0.7.x, either simply:
...
Here is a technique for switching an existing project to 0.13.12 while
...
will hide it from sbt 0.13.12 but keep it in case you want to switch
back to 0.7.x.

### Create `build.sbt` for 0.13.12
...
0.13.12 `project` directory to something like `project10` and rename
...
libraryDependencies += "org.scala-sbt" % "io" % "0.13.12"
*/         
...
0.13.12, this version is Scala 2.10.6. Because this Scala
...
the current sbt version is 0.13.12, and there are 3 commands left to
run):
...
Your build will now use 0.13.12.
...
sbt 0.13.12 by default suppresses most stack traces and debugging
...
By default, sbt 0.13.12 loads managed libraries from your ivy cache
...
#### What are the commands I can use in 0.13.12 vs. 0.7?
...
0.13.12. If your test code isn't thread-safe then you may want to
...
#### How are inter-project dependencies different in 0.13.12 vs. 0.7?

In 0.13.12, there are three types of project dependencies (classpath,
...
In 0.13.12, declare the specific type of dependency you want. Read
...
#### Where can I find plugins for 0.13.12?
...
The latest development versions of 0.13.12 are available as nightly
...
2.  The version number is the name of the subdirectory and is of the
    form `0.13.12.x-yyyyMMdd-HHmmss`. Use this in a build.properties
    file.
