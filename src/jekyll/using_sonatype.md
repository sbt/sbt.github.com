...
You'll need to PGP sign your artifacts for the Sonatype repository.  Don't worry, there's a [plugin for that](http://www.scala-sbt.org/sbt-pgp/).  Follow the instructions for the plugin and you'll have PGP signed artifacts in no time.
