...
documentation applies to sbt 1.7.0.
...
terminal encodings, HTTP proxies, and JVM options.
  ...
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.7.0/sbt-1.7.0.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.7.0/sbt-1.7.0.tgz
...
```
  ...
  [MSI]: https://github.com/sbt/sbt/releases/download/v1.7.0/sbt-1.7.0.msi
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.7.0/sbt-1.7.0.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.7.0/sbt-1.7.0.tgz
  [AdoptiumOpenJDK]: https://adoptium.net
...
```
  ...
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.7.0/sbt-1.7.0.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.7.0/sbt-1.7.0.tgz
  [RPM]: https://dl.bintray.com/sbt/rpm/sbt-1.7.0.rpm
  [DEB]: https://dl.bintray.com/sbt/debian/sbt-1.7.0.deb
  [Manual-Installation]: Manual-Installation.html
...
It assumes you have installed a recent version of sbt, such as sbt 1.7.0,
...
sbt 1.7.0 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.7.0?
...
1.7.0, this version is Scala 2.12.16. Because this Scala
...
the current sbt version is 1.7.0, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.7.0/sbt-launch.jar
```
