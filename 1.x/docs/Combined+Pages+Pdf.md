...
documentation applies to sbt 1.9.6.
...
It assumes you have installed a recent version of sbt, such as sbt 1.9.6,
...
sbt 1.9.6 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.9.6?
...
1.9.6, this version is Scala 2.12.18. Because this Scala
...
the current sbt version is 1.9.6, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.9.6/sbt-launch.jar
```
