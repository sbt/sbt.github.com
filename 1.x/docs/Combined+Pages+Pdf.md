...
documentation applies to sbt 1.4.2.
...
terminal encodings, HTTP proxies, and JVM options.
  ...
  [ZIP]: https://github.com/sbt/sbt/releases/download/sbt-1.4.2.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/sbt-1.4.2.tgz
...
```
  ...
  [MSI]: https://github.com/sbt/sbt/releases/download/v1.4.2/sbt-1.4.2.msi
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.4.2/sbt-1.4.2.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.4.2/sbt-1.4.2.tgz
  [AdoptOpenJDK]: https://adoptopenjdk.net/
...
```
  ...
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.4.2/sbt-1.4.2.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.4.2/sbt-1.4.2.tgz
  [RPM]: https://dl.bintray.com/sbt/rpm/sbt-1.4.2.rpm
  [DEB]: https://dl.bintray.com/sbt/debian/sbt-1.4.2.deb
  [Manual-Installation]: Manual-Installation.html
...
It assumes you have installed a recent version of sbt, such as sbt 1.4.2,
...
libraryDependencies += "org.scala-sbt" %% "io" % "1.4.2"
*/         
...
1.4.2, this version is Scala 2.12.10. Because this Scala
...
the current sbt version is 1.4.2, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.4.2/sbt-launch.jar
```
...
```
  ...
  [sbtScriptedTests]: https://github.com/sbt/sbt/tree/develop/sbt/src/sbt-test
...
sbt 1.4.2 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.4.2?
...
The latest development versions of 1.4.2 are available as nightly
