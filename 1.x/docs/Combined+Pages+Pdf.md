...
documentation applies to sbt 1.3.4.
...
It assumes you have installed a recent version of sbt, such as sbt 1.3.4,
...
Def.settings {
  try {
    val value = Class.forName("sbt.nio.Keys").getDeclaredField("MODULE
...
1.3.4, this version is Scala 2.12.10. Because this Scala
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.3.4/sbt-launch.jar
```
...
sbt 1.3.4 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.3.4?
...
The latest development versions of 1.3.4 are available as nightly
