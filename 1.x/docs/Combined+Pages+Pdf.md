...
documentation applies to sbt 1.10.10.
...
sbt 1.10.10 by default suppresses most stack traces and debugging
...
On a local machine, a common convention is a `$HOME/.sbt/1.0/credentials.sbt` file, with the following:
...
1.10.10, this version is Scala 2.12.18. Because this Scala
...
the current sbt version is 1.10.10, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.10.10/sbt-launch.jar
```
