...
documentation applies to sbt 1.2.1.
...
Thanks for trying out sbt and *have fun*!
  ...
  [MSI]: https://piccolo.link/sbt-1.2.1.msi
...
terminal encodings, HTTP proxies, and JVM options.
  ...
  [ZIP]: https://piccolo.link/sbt-1.2.1.zip
  [TGZ]: https://piccolo.link/sbt-1.2.1.tgz
...
Download [msi installer][MSI] and install it.
  ...
  [ZIP]: https://piccolo.link/sbt-1.2.1.zip
  [TGZ]: https://piccolo.link/sbt-1.2.1.tgz
  [RPM]: https://dl.bintray.com/sbt/rpm/sbt-1.2.1.rpm
  [DEB]: https://dl.bintray.com/sbt/debian/sbt-1.2.1.deb
  [Manual-Installation]: Manual-Installation.html
...
It assumes you have installed a recent version of sbt, such as sbt 1.2.1,
...
libraryDependencies += "org.scala-sbt" %% "io" % "1.2.1"
*/         
...
1.2.1, this version is Scala 2.12.6. Because this Scala
...
the current sbt version is 1.2.1, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.2.1/sbt-launch.jar
```
...
sbt 1.2.1 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.2.1?
...
The latest development versions of 1.2.1 are available as nightly
...
2.  The version number is the name of the subdirectory and is of the
    form `1.2.1.x-yyyyMMdd-HHmmss`. Use this in a build.properties
    file.
