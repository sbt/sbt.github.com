...
documentation applies to sbt 1.1.4.
...
sbt 1.1.4's many new capabilities can be a bit overwhelming, but
this page should help you migrate to 1.1.4 with a minimum of fuss.
...
#### Step 1: Read the Getting Started Guide for sbt 1.1.4

Reading the [Getting Started Guide][Getting-Started] will
probably save you a lot of confusion.

#### Step 2: Install sbt 1.1.4

Download sbt 1.1.4 as described on
[the setup page][Setup].

You can run 1.1.4 the same way that you run 0.7.x, either simply:
...
Here is a technique for switching an existing project to 1.1.4 while
...
will hide it from sbt 1.1.4 but keep it in case you want to switch
back to 0.7.x.

### Create `build.sbt` for 1.1.4
...
1.1.4 `project` directory to something like `project10` and rename
...
libraryDependencies += "org.scala-sbt" %% "io" % "1.1.4"
*/         
...
1.1.4, this version is Scala 2.12.4. Because this Scala
...
the current sbt version is 1.1.4, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.1.4/sbt-launch.jar
```
...
sbt 1.1.4 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.1.4?
...
The latest development versions of 1.1.4 are available as nightly
...
2.  The version number is the name of the subdirectory and is of the
    form `1.1.4.x-yyyyMMdd-HHmmss`. Use this in a build.properties
    file.
