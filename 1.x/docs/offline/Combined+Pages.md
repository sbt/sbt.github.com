...
documentation applies to sbt 1.7.2.
...
It assumes you have installed a recent version of sbt, such as sbt 1.7.2,
...
sbt 1.7.2 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.7.2?
...
1.7.2, this version is Scala 2.12.16. Because this Scala
...
the current sbt version is 1.7.2, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.7.2/sbt-launch.jar
```
