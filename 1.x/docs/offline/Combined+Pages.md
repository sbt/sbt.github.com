...
documentation applies to sbt 1.4.4.
...
```
  ...
  [MSI]: https://github.com/sbt/sbt/releases/download/v1.4.4/sbt-1.4.4.msi
...
```
  ...
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.4.4/sbt-1.4.4.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.4.4/sbt-1.4.4.tgz
  [RPM]: https://dl.bintray.com/sbt/rpm/sbt-1.4.4.rpm
  [DEB]: https://dl.bintray.com/sbt/debian/sbt-1.4.4.deb
  [Manual-Installation]: Manual-Installation.html
...
It assumes you have installed a recent version of sbt, such as sbt 1.4.4,
...
libraryDependencies += "org.scala-sbt" %% "io" % "1.4.4"
*/         
...
1.4.4, this version is Scala 2.12.10. Because this Scala
...
the current sbt version is 1.4.4, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.4.4/sbt-launch.jar
```
...
sbt 1.4.4 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.4.4?
