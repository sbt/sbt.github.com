...
documentation applies to sbt 1.6.2.
...
terminal encodings, HTTP proxies, and JVM options.
  ...
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.6.2/sbt-1.6.2.tgz
...
```
  ...
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.6.2/sbt-1.6.2.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.6.2/sbt-1.6.2.tgz
  [RPM]: https://dl.bintray.com/sbt/rpm/sbt-1.6.2.rpm
  [DEB]: https://dl.bintray.com/sbt/debian/sbt-1.6.2.deb
  [Manual-Installation]: Manual-Installation.html
...
It assumes you have installed a recent version of sbt, such as sbt 1.6.2,
...
sbt 1.6.2 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.6.2?
...
[info]     core (2.12.15, 2.11.12)
[info] Excluding projects:
[info]   * root ()
[info]     network (2.12.15)
[info] Reapplying settings...
...
1.6.2, this version is Scala 2.12.14. Because this Scala
...
the current sbt version is 1.6.2, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.6.2/sbt-launch.jar
```
