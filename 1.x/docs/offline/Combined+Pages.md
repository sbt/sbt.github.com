...
```
  ...
  [ZIP]: https://github.com/sbt/sbt/releases/download/v1.6.1/sbt-1.6.1.zip
  [TGZ]: https://github.com/sbt/sbt/releases/download/v1.6.1/sbt-1.6.1.tgz
  [RPM]: https://dl.bintray.com/sbt/rpm/sbt-1.6.1.rpm
  [DEB]: https://dl.bintray.com/sbt/debian/sbt-1.6.1.deb
  [Manual-Installation]: Manual-Installation.html
...
It assumes you have installed a recent version of sbt, such as sbt 1.6.1,
...
sbt 1.6.1 by default suppresses most stack traces and debugging
...
#### Where can I find plugins for 1.6.1?
...
libraryDependencies += "org.scala-sbt" %% "io" % "1.6.1"
*/         
...
1.6.1, this version is Scala 2.12.14. Because this Scala
...
the current sbt version is 1.6.1, and there are 3 commands left to
run):
...
-XX:ReservedCodeCacheSize=256M
-jar
/home/travis/.sbt/launchers/1.6.1/sbt-launch.jar
```
