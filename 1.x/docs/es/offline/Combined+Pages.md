...
See instruction to install manually.
  ...
  [sbt-launch.jar]: https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.2.3/sbt-launch.jar
...
para forzar el uso de sbt 1.2.3. sbt es 99% compatible (con respecto
