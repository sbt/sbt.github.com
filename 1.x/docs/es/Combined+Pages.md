...
disponible escribe:
  ...
  [sbt-launch.jar]: https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.3.4/sbt-launch.jar
...
para forzar el uso de sbt 1.3.4. sbt es 99% compatible (con respecto
...
instalado una versión reciente de sbt, como sbt 1.3.4, que sabes cómo 
